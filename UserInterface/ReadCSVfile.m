...
% ReadCSVfile - read 5-joint trajectory file for chunked playback
%
...
%   first 6 numeric columns in that order
    ...
    bottom_tx = clampSigned90(round(bottom + offset));
    mid_tx    = clampSigned90(round(mid + offset));
    top_tx    = clampSigned90(round(top + offset));
    elbow_tx  = clampSigned90(round(elbow + offset));
    wrist_tx  = clampSigned90(round(wrist + offset));
